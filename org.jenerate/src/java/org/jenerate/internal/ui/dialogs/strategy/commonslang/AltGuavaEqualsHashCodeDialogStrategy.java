 ...
 * @author maudrain
 */
public final class AltGuavaEqualsHashCodeDialogStrategy implements DialogStrategy<EqualsHashCodeGenerationData> {
    ...
    public StrategyIdentifier getStrategyIdentifier() {
        return MethodContentStrategyIdentifier.USE_ALTGUAVA;
    }
